...
class TopBar extends StatelessWidget {
  double height;
  TopBar({@required this.height, Key key}) : super(key: key);
...
class CurvePainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = const Color(0xff65eaea);
    ...
    paint.color = const Color(0xff4cdcdc);
    canvas.drawPath(path, paint);
    ...
    paint.color = const Color(0xff38d0d0);
    canvas.drawPath(path, paint);
  }
